...
public class _02_AddressFunctionality extends GenelWebDriver {
   ...
   void addAddress(){
       ...
       firsName.sendKeys("Seyhun");

       WebElement lastname=driver.findElement(By.id("input-lastname"));
       lastname.sendKeys("Asci");
       ...
       address1.sendKeys("Barbaros mah.");

       WebElement address2=driver.findElement(By.id("input-address-2"));
       address2.sendKeys("Mehmet Cavus");

       WebElement city=driver.findElement(By.id("input-city"));
       city.sendKeys("Çanakkale");

       WebElement postCode=driver.findElement(By.id("input-postcode"));
       postCode.sendKeys("17100");
